...
const TransactionHistory: React.FC = () => {
  ...
  const [error, setError] = useState<string | null>(null);
    ...
    const transactionId = "5b71bc39675df2bdc8671776b489ec3feedc0d7e052b9744a7520cf109c60eb6";
          ...
          <div className="transaction-details">
            <div className="transaction-info">
              ...
              <div className="info-row">
                ...
                <span className="info-value">
                  {transactionData?.data.item.blockchainSpecific.confirmations}{" "}
                  Confirmed
                </span>
              </div>
              <hr />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {transactionData?.data.item.senders.reduce(
                        (total, sender) => total + parseFloat(sender.amount),
                        0
                      )}{" "}
                      BTC
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      {transactionData
                        ? (
                            parseFloat(transactionData.data.item.fee.amount) /
                            transactionData.data.item.blockchainSpecific.size
                          ).toFixed(20)
                        : "N/A"}{" "}
                      BTC
                  ...
                  {transactionData &&
                    transactionData.data.item.blockchainSpecific.vout.map(
                      (output, index) => (
                        <tr key={index}>
                          <td>{index}</td>
                          <td>{output.scriptPubKey.addresses.join(", ")}</td>
